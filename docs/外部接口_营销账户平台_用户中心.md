...
正常时的返回JSON数据包示例：
    ...
    {"errcode":0,"errmsg":"查询成功","paymentCodeMD5":"EQ#","paymentCodeDES":"NON"}
...
参数|必须|说明
-------|------|-------
paymentCodeMD5|是|有油贷支付密码状态,EQ# 与用户密码相同,NON未设置密码
paymentCodeDES|是|pos消费支付密码状态,EQ# 与用户密码相同,NON未设置密码
